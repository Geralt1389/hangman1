...
class hangman:
    ...
    word_list = ['apple', 'apricot', 'banana', 'blueberry', 'cherry', 'Durian', 'grape', 'grapefruit', 'guava',
                 'honeydew', 'kiwifruit', 'lemon', 'lime', 'lychee', 'mango', 'orange', 'passionfruit', 'peach', 'plum',
                 'pear', 'pineapple', 'Pomegranate', 'autonomy', 'raspberry', 'star fruit', 'strawberry', 'watermelon',]
